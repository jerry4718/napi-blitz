...
export declare class DocHandle {
   ...
   */
  findAllByClassNameIn(root: NodeHandle, className: string): Array<object>
  /**
...
export declare class NodeHandle {
  ...
  appendChild(child: NodeHandle): object
  insertBefore(node: NodeHandle, anchor?: NodeHandle | undefined | null): object
  remove(): void
  replaceWith(node: NodeHandle): object
