...
export class MouseEvent extends UIEvent {
  ...
  get screenX() { return this._ptr.screenX; }
  get screenY() { return this._ptr.screenY; }
  get clientX() { return this._ptr.clientX; }
  get clientY() { return this._ptr.clientY; }
  get pageX() { return this._ptr.pageX; }
  get pageY() { return this._ptr.pageY; }
  get button() { return this._ptr.button; }
  get buttons() { return this._ptr.buttons; }
  get ctrlKey() { return (this._ptr.modsBits & 2) !== 0; }
  get shiftKey() { return (this._ptr.modsBits & 1) !== 0; }
  get altKey() { return (this._ptr.modsBits & 4) !== 0; }
  get metaKey() { return (this._ptr.modsBits & 8) !== 0; }
}

/** Pointer events: pointerdown, pointermove, pointerup, etc. */
export class PointerEvent extends MouseEvent {
  get pointerId() { return this._ptr.pointerId; }
  get pointerType() { return this._ptr.kind; }
  get isPrimary() { return this._ptr.isPrimary; }
  get pressure() { return this._ptr.pressure; }
  get tiltX() { return this._ptr.tiltX; }
  get tiltY() { return this._ptr.tiltY; }
  get twist() { return this._ptr.twist; }
}
...
export class WheelEvent extends UIEvent {
  ...
  get deltaMode() { return this._wheel.mode === "lines" ? 1 : 0; }
  get pageX() { return this._wheel.pageX; }
  get pageY() { return this._wheel.pageY; }
  get clientX() { return this._wheel.clientX; }
  get clientY() { return this._wheel.clientY; }
  get buttons() { return this._wheel.buttons; }
  get ctrlKey() { return (this._wheel.modsBits & 2) !== 0; }
  get shiftKey() { return (this._wheel.modsBits & 1) !== 0; }
  get altKey() { return (this._wheel.modsBits & 4) !== 0; }
  get metaKey() { return (this._wheel.modsBits & 8) !== 0; }
}
...
export class KeyboardEvent extends UIEvent {
  ...
  get ctrlKey() { return (this._key.modsBits & 2) !== 0; }
  get shiftKey() { return (this._key.modsBits & 1) !== 0; }
  get altKey() { return (this._key.modsBits & 4) !== 0; }
  get metaKey() { return (this._key.modsBits & 8) !== 0; }
...
export class InputEvent extends UIEvent {
  ...
  get data() { return this._input.value; }
  get inputType() { return this.type; }
}
...
export class CompositionEvent extends UIEvent {
  ...
  get data() { return this._ime.text ?? ""; }
}
